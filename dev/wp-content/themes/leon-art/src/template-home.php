...
<main class="c-main c-home ">
    ...
    <section class="o-wrapper u-margin-bottom-large">
        <h2 class="c-section__title">Prochain événement</h2>
    ...
    <section class="o-wrapper u-margin-bottom-large">
        <h2 class="c-section__title">Dernières actualités</h2>
    ...
    <section class="o-box c-colorblock">
        <h2 class="c-section__title">Nos réseaux sociaux</h2>
        <ul>
    ...
    <section class="o-box c-instagramfeed">
        <h2 class="c-section__title">Nos photos Instagram</h2>
        <ol>
